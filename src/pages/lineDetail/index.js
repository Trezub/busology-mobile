                ...
                <FlatList
                    ...
                    renderItem={({ item: car }) => (
                        <View style={styles.car}>
                            <View style={[styles.lineCode, { marginBottom: 10 }]}><Text>{car.code}</Text></View>
                            <View style={{ flexDirection: 'row' }}>
                                <View style={{ marginLeft: 10, flex: 1 }} >
                                    <Text>Tipo: {carTypes[car.type] || 'Desconhecido'}</Text>
                                    <Text>Status do carro: {car.operational.status}</Text>
                                    <Text>Sentido: {car.operational.direction || 'Desconhecido'}</Text>
                                    ...
                                    <Text>Visto por último: {new Date(car.lastSeen).toLocaleTimeString([], {timeStyle: 'short'})}</Text>
                                </View>
